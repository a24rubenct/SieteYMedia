...
public class InterfaceConsola {
    ...
    void presentarJuego() {
        ...
        System.out.print("- Si la suma de los valores de las cartas sacadas es superior a 7 y medio, el jugador 'se pasa de siete y medio' y pierde.");
    ...
    void turnoBanca() {
        double valorCartasJugador = juego.valorCartasJugador();
